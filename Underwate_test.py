...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_dir", type=str, default="./data/test/", help="path of test images")  #"./data/Paired/UIEBD/validation/"
    parser.add_argument("--sample_dir", type=str, default="./data/output/", help="path to save generated image")
